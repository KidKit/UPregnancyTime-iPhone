...
{
    CGRect bounds = rect;
    CGFloat yOffset = kTabDemoVerticalItemPaddingSize.height + 2.;
    ...
    [textColor set];
    [self.title drawAtPoint:CGPointMake(titleMarginWidth, yOffset + 6.) withFont:kTabDemoVerticalItemFont];
}
